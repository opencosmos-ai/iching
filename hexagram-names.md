...
column only by his approval, and only then goes into a `render:` field and a
...
- ***action within → without*** — 說卦 ch 7's action for each trigram, in the English of
  ...
  in (31 咸 止而說, "holding → releasing"), and **it is commentary: it checks a name and never
  supplies one.**

These three columns were generated once, on 2026-09-24, from `generated/iching-data.ts`, so they
...
| # | | pinyin | within · without | spectrums | action within → without | English | other candidates | why, in brief | status |
|---|---|---|---|---|---|---|---|---|---|
| 1 | 乾 | qián | sky (yang) · sky (yang) | sky ↔ earth, **doubled** | vigour → vigour | **Striving** | Vigour · Drive · Sky | 乾乾 (*qián qián*) in line 3 needs a verb: "striving all day, wary at dusk". 強 is locked to *strong*; *vigour* is kept for 34 | proposed |
| 2 | 坤 | kūn | earth (yin) · earth (yin) | sky ↔ earth, **doubled** | going along → going along | **Carrying** | Earth · Compliance · Accord | 坤厚載物, "坤 is thick and carries things"; 地勢坤 reads "the lie of the land carries". 弱 is locked to *yielding* and 生 to *bear*. Pairs with 1 | proposed |
| 3 | 屯 | zhūn | thunder (yang) · water (yang) | thunder ↔ wind × water ↔ fire | moving out → sinking in | **Sprouting** | First Growth · Holding Back · Difficult Beginning | 說文: a sprout piercing the ground-line, 屯然而難; 序卦 物之始生. Stays out of the difficulty cluster. *Seam:* 屯其膏 (line 5) reads *tún*, "hoard" | proposed |
| 4 | 蒙 | méng | water (yang) · mountain (yang) | water ↔ fire × mountain ↔ lake | sinking in → holding | **Unknowing** | Covering · Ignorance · Obscurity | Survives every line: "the child's unknowing", "lift the unknowing", "strike the unknowing". 說文: a vine that covers | proposed |
| 5 | 需 | xū | sky (yang) · water (yang) | sky ↔ earth × water ↔ fire | vigour → sinking in | **Waiting** | Biding · Held Up | Waiting at the outskirts, in the sand, the mud, the blood. 說文 遇雨不進 ("meets rain, does not go on"). Legge and McClatchie agree; de Harlez reads *obstacle* | proposed |
| 6 | 訟 | sòng | water (yang) · sky (yang) | water ↔ fire × sky ↔ earth | sinking in → vigour | **Dispute** | Lawsuit · Contention · Quarrel | Can be won or lost (不克訟). *Contention* is the parent project's word for 爭 | proposed |
| 7 | 師 | shī | water (yang) · earth (yin) | water ↔ fire × sky ↔ earth | sinking in → going along | **The Army** | Troops · The Host | All five lines and every use elsewhere (行師, 大師). 眾 is locked, with *multitude* forbidden | proposed |
| 8 | 比 | bǐ | earth (yin) · water (yang) | sky ↔ earth × water ↔ fire | going along → sinking in | **Drawing Near** | Alliance · Closeness · Union | 說文: two figures side by side. Works in 比之匪人 ("drawing near to the wrong people"). 執 forbids *attachment* | proposed |
| 9 | 小畜 | xiǎo chù | sky (yang) · wind (yin) | sky ↔ earth × thunder ↔ wind | vigour → entering | **Small Keeping** | Small Taming · Small Restraint · Small Store | 畜 = keeping: livestock, stores, holding back. Must also serve the verb 畜 at 30 (畜牝牛, "keep a cow") and 33. Pairs with 26 | proposed |
| 10 | 履 | lǚ | lake (yin) · sky (yang) | mountain ↔ lake × sky ↔ earth | releasing → vigour | **Treading** | Tread · Footing · Conduct | Tread on the tiger's tail; plain treading. All three translators agree | proposed |
| 11 | 泰 | tài | sky (yang) · earth (yin) | sky ↔ earth, **crossed** | vigour → going along | **Flow** | Passage · Free Flow · Meeting · Peace · see § pending | 說文 滑 (water through hands); 序卦 泰者通也. *Peace* is unsupported: 序卦 puts 安 after 泰. **Waits on 亨** (A6) | pending |
| 12 | 否 | pǐ | earth (yin) · sky (yang) | sky ↔ earth, **crossed** | going along → vigour | **Blockage** | Stagnation · Obstruction · Closing · Standstill · see § pending | "The blockage rests", "topple the blockage", "first blocked, then glad". Pairs with 11. **Waits on 亨** | pending |
| 13 | 同人 | tóng rén | fire (yin) · sky (yang) | water ↔ fire × sky ↔ earth | attaching → vigour | **People Together** | Joining People · Fellowship · Companionship | "People together in the open country / at the gate". Keeping 人 matches 37 家人 | proposed |
| 14 | 大有 | dà yǒu | sky (yang) · fire (yin) | sky ↔ earth × water ↔ fire | vigour → attaching | **Great Possession** | Great Having · Great Holdings · Great Harvest · see § pending | 大 is locked to *great*. 有 here is having, not the Tao Te Ching's presence. **Waits on the 有 question** | pending |
| 15 | 謙 | qiān | mountain (yang) · earth (yin) | mountain ↔ lake × sky ↔ earth | holding → going along | **Modesty** | Humility · Deference · Lowliness | "Modest, modest noble one". *Modus* is measure, which matches 稱物平施 ("weigh things and give evenly") | proposed |
| 16 | 豫 | yù | earth (yin) · thunder (yang) | sky ↔ earth × thunder ↔ wind | going along → moving out | **Ease** | Delight · Readiness · Contentment | Takes every modifier (crowing ease, benighted ease). 說文: a large elephant that harms nothing. Leaves *delight* for 58 | proposed |
| 17 | 隨 | suí | thunder (yang) · lake (yin) | thunder ↔ wind × mountain ↔ lake | moving out → releasing | **Following** | Follow · Going Along | Works in both lines, and as "what follows" (the leg) in 31 and 52 | proposed |
| 18 | 蠱 | gǔ | wind (yin) · mountain (yang) | thunder ↔ wind × mountain ↔ lake | entering → holding | **Rot** | Decay · Corruption · Blight | 說文 皿蟲: worms in a vessel. "Set right the father's rot". *Affairs* is locked to 事, which occurs in 18.6 | proposed |
| 19 | 臨 | lín | lake (yin) · earth (yin) | mountain ↔ lake × sky ↔ earth | releasing → going along | **Overseeing** | Presiding · Approach · Drawing Near | 說文 監臨: bending to look down. "Sweet overseeing", "knowing overseeing". 王 is locked to *ruler* | proposed |
| 20 | 觀 | guān | earth (yin) · wind (yin) | sky ↔ earth × thunder ↔ wind | going along → entering | **Watching** | View · Observing · Contemplation | "A child's watching", "watch my life". Matches the parent's 觀 (ch 16). *Seam:* traditional *guàn*, "display" | proposed |
| 21 | 噬嗑 | shì kè | thunder (yang) · fire (yin) | thunder ↔ wind × water ↔ fire | moving out → attaching | **Biting Through** | Bite and Close · Jaws Closing | Shares "bite" with all four 噬 lines; Wang Bi 齧而合之. Pinyin kept at modern *shì kè* (traditional *shì hé*) | proposed |
| 22 | 賁 | bì | fire (yin) · mountain (yang) | water ↔ fire × mountain ↔ lake | attaching → holding | **Adornment** | Ornament · Embellishment | Adorn his toes; adorned and glistening; white adornment. 明 is locked, so *radiance* is out | proposed |
| 23 | 剝 | bō | earth (yin) · mountain (yang) | sky ↔ earth × mountain ↔ lake | going along → holding | **Stripping** | Stripping Away · Peeling · Collapse | The lines are transitive (strip the bed at the legs… to the skin), which rules out *collapse* | proposed |
| 24 | 復 | fù | thunder (yang) · earth (yin) | thunder ↔ wind × sky ↔ earth | moving out → going along | **Return** | Returning · Coming Back | Eight lines ("a lost return", "returning alone"). Agrees with the parent's 復命 | proposed |
| 25 | 无妄 | wú wàng | thunder (yang) · sky (yang) | thunder ↔ wind × sky ↔ earth | moving out → vigour | **Innocence** | Without Recklessness · The Unexpected · Without Pretence · see § pending | Works in every line ("an innocent's calamity"). *Blameless* would collide with 无咎 in 25.4. **Waits on A11** | pending |
| 26 | 大畜 | dà chù | sky (yang) · mountain (yang) | sky ↔ earth × mountain ↔ lake | vigour → holding | **Great Keeping** | Great Taming · Great Restraint · Great Store | Paired with 9. The ox's horn-board and the gelded boar favour *Taming* here, but 9's clouds and cart do not | proposed |
| 27 | 頤 | yí | thunder (yang) · mountain (yang) | thunder ↔ wind × mountain ↔ lake | moving out → holding | **Jaws** | Nourishing · Feeding | Survives all seven (朵頤, "working jaws"); the nourishing comes out of the image. *Mouth* collides with 口實 in its own judgment | proposed |
| 28 | 大過 | dà guò | wind (yin) · lake (yin) | thunder ↔ wind × mountain ↔ lake | entering → releasing | **Great Exceeding** | Great Excess · Great Overstepping · Great Overload | Must match 62, where 過 is a verb four times. *Excess* is a noun only | proposed |
| 29 | 坎 | kǎn | water (yang) · water (yang) | water ↔ fire, **doubled** | sinking in → sinking in | **The Pit** | Hollow · Water · The Pit Doubled | Every use is a pit (入于坎窞; 說文 quotes this line). *Danger* would read "danger has danger" (坎有險) | proposed |
| 30 | 離 | lí | fire (yin) · fire (yin) | water ↔ fire, **doubled** | attaching → attaching | **Blaze** | Fire · Attaching · Glow | "Yellow blaze", "the blaze of the setting sun", 焚如. Clears the 明 lock. *Seam:* 說文 reads 離 as the yellow oriole, and 黃離 matches it | proposed |
| 31 | 咸 | xián | mountain (yang) · lake (yin) | mountain ↔ lake, **crossed** | holding → releasing | **Touch** | Stirring · Feeling · Influence | Touch his big toe, calf, thigh, jaws; also *touched* in feeling (感). 彖 止而說 | proposed |
| 32 | 恆 | héng | wind (yin) · thunder (yang) | thunder ↔ wind, **crossed** | entering → moving out | **Constancy** | Enduring · Duration · Lasting | The translators agree. 常 is locked to *the abiding*; 貞 needs *perseverance* | proposed |
| 33 | 遯 | dùn | mountain (yang) · sky (yang) | mountain ↔ lake × sky ↔ earth | holding → vigour | **Withdrawal** | Retreat · Escape | "A fine withdrawal". Leaves *retreat* for 退 in 進退 | proposed |
| 34 | 大壯 | dà zhuàng | sky (yang) · thunder (yang) | sky ↔ earth × thunder ↔ wind | vigour → moving out | **Great Vigour** | Great Strength · Vigour of the Great | 說文 壯: a man in his prime. "Vigour in the toes", "the horse is vigorous" (36, 59). 強 is locked to *strong* | proposed |
| 35 | 晉 | jìn | earth (yin) · fire (yin) | sky ↔ earth × water ↔ fire | going along → attaching | **Progress** | Advance · Rising | Leaves *advance* for 進. 說文: the sun rises and all things go forward | proposed |
| 36 | 明夷 | míng yí | fire (yin) · earth (yin) | water ↔ fire × sky ↔ earth | attaching → going along | **Clarity Wounded** | Clarity Brought Low · Clarity Hidden | 明 is locked to *clarity*; 夷于左股 repeats 夷 as a verb, "wounded"; 雜卦 has 誅 | proposed |
| 37 | 家人 | jiā rén | fire (yin) · wind (yin) | water ↔ fire × thunder ↔ wind | attaching → entering | **The Household** | Family · Kin | Includes wives, children and dependents; fits 閑有家 and 富家 | proposed |
| 38 | 睽 | kuí | lake (yin) · fire (yin) | mountain ↔ lake × water ↔ fire | releasing → attaching | **Estrangement** | Divergence · Opposition · Looking Apart | 雜卦 家人內也 / 睽外也: the outside to 37's inside. 說文: eyes that do not heed each other. 睽孤, "estranged and alone" | proposed |
| 39 | 蹇 | jiǎn | mountain (yang) · water (yang) | mountain ↔ lake × water ↔ fire | holding → sinking in | **Hobbling** | Limping · Halting · Hardship | 說文 跛, lame. "Going, hobbling; coming, praise". Hobbled legs are tied, which sets up 40's release | proposed |
| 40 | 解 | xiè | water (yang) · thunder (yang) | water ↔ fire × thunder ↔ wind | sinking in → moving out | **Release** | Loosening · Untying · Deliverance | "Release your big toe"; pardon (赦), escape (免). *Deliverance* has a devotional register | proposed |
| 41 | 損 | sǔn | lake (yin) · mountain (yang) | mountain ↔ lake, **crossed** | releasing → holding | **Decrease** | Diminishing · Reduction | 說文 減. Agrees with the parent project (chs 42 and 48). *Loss* is taken by 喪 | proposed |
| 42 | 益 | yì | thunder (yang) · wind (yin) | thunder ↔ wind, **crossed** | moving out → entering | **Increase** | Benefit · Gain · Enrichment | Paired with 41. *Gain* is taken by 得; *benefit* sits too near 利 | proposed |
| 43 | 夬 | guài | sky (yang) · lake (yin) | sky ↔ earth × mountain ↔ lake | vigour → releasing | **Resolve** | Parting · Breakthrough · Decision | 夬夬 must double ("resolute, resolute"); Wang Bi 決之不疑. *Seam:* the graph is a split, a breach | proposed |
| 44 | 姤 | gòu | wind (yin) · sky (yang) | thunder ↔ wind × sky ↔ earth | entering → vigour | **Encounter** | Meeting · Coupling | Every Wing glosses 遇. Keeps *meet* free for 遇 itself. *Seam:* 說文 偶, mate | proposed |
| 45 | 萃 | cuì | earth (yin) · lake (yin) | sky ↔ earth × mountain ↔ lake | going along → releasing | **Gathering** | Assembly · Massing · Union | "Now disorder, now gathering"; stands beside 亂 (*disorder*). 說文: thick grass | proposed |
| 46 | 升 | shēng | wind (yin) · earth (yin) | thunder ↔ wind × sky ↔ earth | entering → going along | **Ascent** | Ascending · Climbing · Rising | "Ascend the steps / into an empty city". The translators agree | proposed |
| 47 | 困 | kùn | water (yang) · lake (yin) | water ↔ fire × mountain ↔ lake | sinking in → releasing | **Hemmed In** | Confinement · Straits · Exhaustion | 說文: a tree inside an enclosure. "Hemmed in by wine and food". *Exhaustion* is kept for 窮 | proposed |
| 48 | 井 | jǐng | wind (yin) · water (yang) | thunder ↔ wind × water ↔ fire | entering → sinking in | **The Well** | Wellspring | All three translators, eleven uses. *Wellspring* collides with 泉 | proposed |
| 49 | 革 | gé | fire (yin) · lake (yin) | water ↔ fire × mountain ↔ lake | attaching → releasing | **Shedding** | Change · Molting · Revolution | 說文: a hide with the hair stripped; 雜卦 去故 ("removes the old"). *Change* collides with 改 and 變 in its own lines | proposed |
| 50 | 鼎 | dǐng | wind (yin) · fire (yin) | thunder ↔ wind × water ↔ fire | entering → attaching | **The Cauldron** | Tripod · Vessel | All three translators. 器 is locked to *vessel* | proposed |
| 51 | 震 | zhèn | thunder (yang) · thunder (yang) | thunder ↔ wind, **doubled** | moving out → moving out | **Thunderclap** | Thunder · Shock · Quake | 說文 劈歴, the single strike. "The thunderclap comes", "strikes not his body but his neighbour's". Stays distinct from 雷 | proposed |
| 52 | 艮 | gèn | mountain (yang) · mountain (yang) | mountain ↔ lake, **doubled** | holding → holding | **Stilling** | Keeping Still · Holding Firm · Stopping | "Stilling his back / toes / jaws". *Keeping Still* works as well; it was barred only as the trigram image | proposed |
| 53 | 漸 | jiàn | mountain (yang) · wind (yin) | mountain ↔ lake × thunder ↔ wind | holding → entering | **By Degrees** | Gradual Advance · By Stages | The manner, not the motion (坤文言 其所由來者漸矣). Keeps clear of 35 and 46 | proposed |
| 54 | 歸妹 | guī mèi | lake (yin) · thunder (yang) | mountain ↔ lake × thunder ↔ wind | releasing → moving out | **The Younger Sister's Marriage** | The Younger Sister Given in Marriage · Marrying Off the Younger Sister · The Marrying Maiden | Keeps 妹 ("younger sister") and the 娣 system the lines depend on. Long | proposed |
| 55 | 豐 | fēng | fire (yin) · thunder (yang) | water ↔ fire × thunder ↔ wind | attaching → moving out | **Abundance** | Fullness · Plenty | 說文: a ritual dish heaped full. *Great* is locked to 大. *Seam:* the 彖 argues fullness at noon, just before decline | proposed |
| 56 | 旅 | lǚ | mountain (yang) · fire (yin) | mountain ↔ lake × water ↔ fire | holding → attaching | **The Traveller** | The Stranger · The Sojourner · The Wanderer | Subject of every line (burns his lodging). *Sojourner* is chiefly biblical | proposed |
| 57 | 巽 | xùn | wind (yin) · wind (yin) | thunder ↔ wind, **doubled** | entering → entering | **Kneeling** | Lying Low · Yielding · Submission · Entering | 說文: two kneeling figures. "Kneeling beneath the couch", "kneeling again and again". 雜卦 巽伏 | proposed |
| 58 | 兌 | duì | lake (yin) · lake (yin) | mountain ↔ lake, **doubled** | releasing → releasing | **Delight** | Talk · Pleasing · Gladness | Takes every modifier (harmonious delight, delight that comes). *Live fork:* 說 read as speech gives *Talk*, which also fits every line | proposed |
| 59 | 渙 | huàn | water (yang) · wind (yin) | water ↔ fire × thunder ↔ wind | sinking in → entering | **Scattering** | Dispersal · Dissolving · Flowing Out | Transitive: scatter his flock, his blood. 雜卦 pairs it with 60 (渙離也，節止也) | proposed |
| 60 | 節 | jié | lake (yin) · water (yang) | mountain ↔ lake × water ↔ fire | releasing → sinking in | **Restraint** | Measure · Limits · Joints | "Bitter / sweet restraint"; "does not know restraint" (64's 小象). 說文: the bamboo joint | proposed |
| 61 | 中孚 | zhōng fú | lake (yin) · wind (yin) | mountain ↔ lake × thunder ↔ wind | releasing → entering | **Confidence Within** | Inner Confidence · Truth Within · Holding True · The Hatching · see § pending | 雜卦 中孚信也, but 信 is locked to *trust*, with *sincerity* and *faith* forbidden. **Waits on 孚** (A6) | pending |
| 62 | 小過 | xiǎo guò | mountain (yang) · thunder (yang) | mountain ↔ lake × thunder ↔ wind | holding → moving out | **Small Exceeding** | Small Excess · Small Overstepping | 彖 小者過, so 小 is the subject, not "slightly" | proposed |
| 63 | 既濟 | jì jì | fire (yin) · water (yang) | water ↔ fire, **crossed** | attaching → sinking in | **Already Across** | Crossing Complete · After the Crossing · Completion | Keeps the fox and the river. Pairs with 64 | proposed |
| 64 | 未濟 | wèi jì | water (yang) · fire (yin) | water ↔ fire, **crossed** | sinking in → attaching | **Not Yet Across** | Crossing Incomplete · Unfinished | "Not yet across: setting out is ominous" (64.3) | proposed |
...
Chinese in each cell is the text; the bold English is this brief's reading of it.)*

| Spectrum | Odd line | Figure (bottom → top) | Action (說卦 ch 7) | Image (說卦 ch 3) |
|---|---|---|---|---|
| sky ↔ earth | none | `111` ↔ `000` — **all firm ↔ all yielding** | 健 (*jiàn*) ↔ 順 (*shùn*) — **vigour ↔ going-along-with** | 天 ↔ 地, 定位 — **above ↔ below**: "they set the positions" |
| thunder ↔ wind | bottom | `100` ↔ `011` — **firm at the base ↔ open at the base** | 動 (*dòng*) ↔ 入 (*rù*) — **moving out ↔ entering** | 雷 ↔ 風, 相薄 — **strike ↔ pervade**: "they rouse each other" |
...
| mountain ↔ lake | top | `001` ↔ `110` — **closed at the top ↔ open at the top** | 止 (*zhǐ*) ↔ 說 (*yuè*) — **holding ↔ releasing** | 山 ↔ 澤, 通氣 — **height ↔ hollow**: "they exchange breath" |
...
underneath. Water is a firm line held inside open ones — the strength (and the danger) hidden in the
middle; fire is an open line inside firm ones — a hollow centre, bright at the edges, needing
something to cling to. Mountain is two open lines capped by a firm one — a lid, a ridge; lake is two
...
**As a check, not a source.** Every name in this file can be read against its signature: 31 *Touch*
against 止而說 ("holding within, releasing without"), 17 *Following* against 動而說, 39 *Hobbling*
against 險 ahead and 止 below (彖 見險而能止). A name its signature cannot account for is worth a
second look. A name its signature *writes* is the opposite danger: the signature is commentary, the
shape of an answer, and ruling 1 above says the name comes from **the lines**
