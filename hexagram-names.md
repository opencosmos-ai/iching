...
- ***action within → without*** — 說卦 ch 7's action for each trigram, in the English of
  ...
  in (31 咸 止而說, "holding → releasing"), and **it is commentary: it may suggest a
...
| 4 | 蒙 | méng | water (yang) · mountain (yang) | water ↔ fire × mountain ↔ lake | sinking in → holding | **Unknowing** | deepens | Covering · Ignorance · Obscurity · ◇ Unopened ✓ · ◇ The Covered Spring ✗ | Survives every line: "the child's unknowing", "lift the unknowing", "strike the unknowing". 說文: a vine that covers | proposed |
...
| 14 | 大有 | dà yǒu | sky (yang) · fire (yin) | sky ↔ earth × water ↔ fire | vigour → attaching | **Great Possession** | strains | Great Having · Great Holdings · Great Harvest · see § pending · ◇ Great Having ✓ · ◇ Great Harvest ✓ · ◇ Great Light ✗ | 大 is locked to *great*. 有 here is having, not the Tao Te Ching's presence. **Waits on the 有 question** | pending |
| 15 | 謙 | qiān | mountain (yang) · earth (yin) | mountain ↔ lake × sky ↔ earth | holding → going along | **Modesty** | deepens | Humility · Deference · Lowliness · ◇ Lowliness ✓ strained · ◇ Hidden Height ✗ | "Modest, modest noble one". *Modus* is measure, which matches 稱物平施 ("weigh things and give evenly") | proposed |
...
| 18 | 蠱 | gǔ | wind (yin) · mountain (yang) | thunder ↔ wind × mountain ↔ lake | entering → holding | **Rot** | deepens | Decay · Corruption · Blight · ◇ Festering ✓ · ◇ The Sealed Jar ✗ | 說文 皿蟲: worms in a vessel. "Set right the father's rot". *Affairs* is locked to 事, which occurs in 18.6 | proposed |
...
| 20 | 觀 | guān | earth (yin) · wind (yin) | sky ↔ earth × thunder ↔ wind | going along → entering | **Watching** | supports | View · Observing · Contemplation · ◇ Beholding ✓ · ◇ The Lookout ✗ | "A child's watching", "watch my life". Matches the parent's 觀 (ch 16). *Seam:* traditional *guàn*, "display" | proposed |
...
| 22 | 賁 | bì | fire (yin) · mountain (yang) | water ↔ fire × mountain ↔ lake | attaching → holding | **Adornment** | deepens | Ornament · Embellishment · ◇ Pattern ✓ · ◇ Glow ✗ | Adorn his toes; adorned and glistening; white adornment. 明 is locked, so *radiance* is out | proposed |
| 23 | 剝 | bō | earth (yin) · mountain (yang) | sky ↔ earth × mountain ↔ lake | going along → holding | **Stripping** | supports | Stripping Away · Peeling · Collapse · ◇ Peeling ✓ · ◇ Collapse ✗ | The lines are transitive (strip the bed at the legs… to the skin), which rules out *collapse* | proposed |
...
| 26 | 大畜 | dà chù | sky (yang) · mountain (yang) | sky ↔ earth × mountain ↔ lake | vigour → holding | **Great Keeping** | supports | Great Taming · Great Restraint · Great Store · ◇ Great Restraint ✓ · ◇ Great Store ✗ | Paired with 9. The ox's horn-board and the gelded boar favour *Taming* here, but 9's clouds and cart do not | proposed |
| 27 | 頤 | yí | thunder (yang) · mountain (yang) | thunder ↔ wind × mountain ↔ lake | moving out → holding | **Jaws** | deepens | Nourishing · Feeding · ◇ Nourishing ✗ · ◇ The Mouth ✗ | Survives all seven (朵頤, "working jaws"); the nourishing comes out of the image. *Mouth* collides with 口實 in its own judgment | proposed |
...
| 31 | 咸 | xián | mountain (yang) · lake (yin) | mountain ↔ lake, **crossed** | holding → releasing | **Touch** | deepens | Stirring · Feeling · Influence · ◇ Quickening ✓ · ◇ Response ✗ | Touch his big toe, calf, thigh, jaws; also *touched* in feeling (感). 彖 止而說 | proposed |
...
| 33 | 遯 | dùn | mountain (yang) · sky (yang) | mountain ↔ lake × sky ↔ earth | holding → vigour | **Withdrawal** | deepens | Retreat · Escape · ◇ Receding ✓ · ◇ Keeping Distance ✗ | "A fine withdrawal". Leaves *retreat* for 退 in 進退 | proposed |
...
| 39 | 蹇 | jiǎn | mountain (yang) · water (yang) | mountain ↔ lake × water ↔ fire | holding → sinking in | **Hobbling** | supports | Limping · Halting · Hardship · ◇ Halting ✓ · ◇ Impasse ✗ | 說文 跛, lame. "Going, hobbling; coming, praise". Hobbled legs are tied, which sets up 40's release | proposed |
...
| 41 | 損 | sǔn | lake (yin) · mountain (yang) | mountain ↔ lake, **crossed** | releasing → holding | **Decrease** | deepens | Diminishing · Reduction · ◇ Paring ✓ · ◇ Tribute ✗ | 說文 減. Agrees with the parent project (chs 42 and 48). *Loss* is taken by 喪 | proposed |
...
| 51 | 震 | zhèn | thunder (yang) · thunder (yang) | thunder ↔ wind, **doubled** | moving out → moving out | **Thunderclap** | strains | Thunder · Shock · Quake · ◇ Shock ✓ · ◇ Peals ✓ strained | 說文 劈歴, the single strike. "The thunderclap comes", "strikes not his body but his neighbour's". Stays distinct from 雷 | proposed |
| 52 | 艮 | gèn | mountain (yang) · mountain (yang) | mountain ↔ lake, **doubled** | holding → holding | **Stilling** | deepens | Keeping Still · Holding Firm · Stopping · ◇ Keeping Still ✓ · ◇ Summit ✗ | "Stilling his back / toes / jaws". *Keeping Still* works as well; it was barred only as the trigram image | proposed |
| 53 | 漸 | jiàn | mountain (yang) · wind (yin) | mountain ↔ lake × thunder ↔ wind | holding → entering | **By Degrees** | supports | Gradual Advance · By Stages · ◇ Gradual Advance ✓ · ◇ Rooting ✗ | The manner, not the motion (坤文言 其所由來者漸矣). Keeps clear of 35 and 46 | proposed |
...
| 56 | 旅 | lǚ | mountain (yang) · fire (yin) | mountain ↔ lake × water ↔ fire | holding → attaching | **The Traveller** | supports | The Stranger · The Sojourner · The Wanderer · ◇ The Guest ✓ · ◇ Wildfire ✗ | Subject of every line (burns his lodging). *Sojourner* is chiefly biblical | proposed |
| 57 | 巽 | xùn | wind (yin) · wind (yin) | thunder ↔ wind, **doubled** | entering → entering | **Kneeling** | deepens | Lying Low · Yielding · Submission · Entering · ◇ Getting Under ✓ · ◇ Pervading ✗ | 說文: two kneeling figures. "Kneeling beneath the couch", "kneeling again and again". 雜卦 巽伏 | proposed |
...
| 62 | 小過 | xiǎo guò | mountain (yang) · thunder (yang) | mountain ↔ lake × thunder ↔ wind | holding → moving out | **Small Exceeding** | supports | Small Excess · Small Overstepping · ◇ Small Overstepping ✓ · ◇ Flying Low ✗ | 彖 小者過, so 小 is the subject, not "slightly" | proposed |
...
in this file can be read against its signature: 31 *Touch* against 止而說 ("holding within,
